...
const ArtGalleryMain = () => {
    return <main className="pageContent">
        ...
        <main className="pageContent__artGallery">
            <img className="pageContent__artGallery__bigImage" src={bigImage} alt="galeria-sztuki-bednarscy" />

            <article className="pageContent__artGallery__desc">
                <h2 className="pageContent__artGallery__header">
                ...
                <section className="pageContent__artGallery__images">
